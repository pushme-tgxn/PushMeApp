...
const ViewToken = ({ navigation, route }) => {
    ...
    const [deviceName, setDeviceName] = useState(tokenData.name || Device.deviceName);
    ...
    const deleteRegistration = async () => {
        const fetchResponse = await apiService.deleteTokenRegistration(tokenData.token);
    ...
    return (
        <SafeAreaView style={themedStyles.paneContainer}>
            <ScrollView>
                ...
                <Text style={themedStyles.baseText}>Created: {tokenData.createdAt}</Text>
                <Separator />
          ...
          >
            <Text>{categoryId}</Text>
                ...
                <View style={themedStyles.inputContainerView}>
                    <CustomButton onPress={onSend} title="Push!" style={{ backgroundColor: "green" }} />
                </View>
                <Separator />
